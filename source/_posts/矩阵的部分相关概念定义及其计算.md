...
## 舒尔补
舒尔补通常用于将大的复杂的矩阵分解成小的易于解决的矩阵，更具体地，通常用于
...
$M=\begin{bmatrix} A & B \\\ C & D\end{bmatrix}, \mathbf{x}=\begin{bmatrix} \mathbf{x\_1} \\\ \mathbf{x\_2}\end{bmatrix}, \mathbf{b}=\begin{bmatrix} \mathbf{b\_1} \\\ \mathbf{b\_2}\end{bmatrix}$
